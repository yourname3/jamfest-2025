...
mod macros_release {
    ...
    macro_rules! release_tweak {
        ($default:expr) => {
            inline_tweak::inline_tweak(None, inline_tweak::absfile!(), std::line!(), std::column!())
                .unwrap_or_else(|| $default)
        };
        ($value:literal; $default:expr) => {
            inline_tweak::inline_tweak(Some($value), inline_tweak::absfile!(), std::line!(), std::column!())
                .unwrap_or_else(|| $default)
        };
    }
    ...
    macro_rules! derive_release_tweak {
        ($default:expr, $fn_name:expr, $position:expr) => {
            inline_tweak::inline_tweak_derive(inline_tweak::absfile!(), $fn_name, $position).unwrap_or($default)
        };
    }
}
...
mod macros_release {
    ...
    macro_rules! derive_release_tweak {
        ($default:expr, $fn_name:expr, $position:expr) => {
            inline_tweak::inline_tweak_derive(inline_tweak::absfile!(), $fn_name, $position)
                .unwrap_or_else(|| $default)
        };
    }
}
...
mod macros_tweak {
    #[macro_export]
    macro_rules! absfile {
        () => { concat!(env!("CARGO_MANIFEST_DIR"), "/../", std::file!()) }
    }
    ...
    macro_rules! watch {
        () => {
            inline_tweak::watch_file(inline_tweak::absfile!());
        };
    }
}
